...
public class InvalidPacketException extends Exception {
     ...
     * that caused the exception. i is the index of the byte that was in error.
     */
    ...
    /**
     * Returns the packet that caused the exception to be thrown. <b>Note:</b>
     * The return-value is a reference to the original array. Changes will
     * likely propagate to other parts of the program.
     */
