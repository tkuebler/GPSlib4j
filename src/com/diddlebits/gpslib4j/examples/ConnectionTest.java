...
class ConnectionTest implements IGPSlistener, IWaypointListener, ITrackpointListener, ILapListener {
	...
	public ConnectionTest() {
		...
		try {
			zPort = CommPortIdentifier.getPortIdentifier("/dev/tty.USA28X2b2P1.1");
	...
	*/		
	...
	public void waypointReceived(IWaypoint wp) {
		// TODO Auto-generated method stub
		System.out.println("Waypoint recieved by connection test: " + wp.toString() + " : " + ((WaypointDataPacket)wp).getRawPacket());
		count = 0;
	}
	...
	public void trackpointReceived(ITrackpoint tp) {
		// TODO Auto-generated method stub
		System.out.println("Trackpoint recieved by connection test: " + ((TrackpointDataPacket)tp).toString() + " : " + ((TrackpointDataPacket)tp).getRawPacket() );
		count = 0;
	}
	...
	public void transferStarted(int number) {
		// TODO Auto-generated method stub
		System.out.println("transfer started notification arrived at connection test: " + number);
		transfering = true;
		count = 0;
	}
	...
	public void transferComplete() {
		// TODO Auto-generated method stub
		System.out.println("transfer complete notification arrived at connection test.");
		transfering = false;
		count = 0;
	}
	...
	public void lapReceived(ILap lp) {
		// TODO Auto-generated method stub
		System.out.println("Lap recieved by connection test: " + ((LapDataPacket)lp).toString() + " : " + ((LapDataPacket)lp).getRawPacket() );
		count = 0;
	}
}